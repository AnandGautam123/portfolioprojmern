...
import type { AlertConfig, BadgeConfig, ButtonConfig, CardConfig, ComponentStyleConfig, ConfigConsumerProps, CSPConfig, DirectionType, DrawerConfig, FlexConfig, ImageConfig, ModalConfig, NotificationConfig, PopupOverflow, TableConfig, TabsConfig, TagConfig, Theme, ThemeConfig, TourConfig, TransferConfig, WaveConfig } from 'antd/es/config-provider/context';
